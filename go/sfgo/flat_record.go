...
const (
	...
	CAP_EFFECTIVE_STR   Attribute = EV_FILE_CAP_EFFECTIVE_STR
	CAP_PERMITTED_STR   Attribute = EV_FILE_CAP_PERMITTED_STR
	CAP_INHERITABLE_STR Attribute = EV_FILE_CAP_INHERITABLE_STR
